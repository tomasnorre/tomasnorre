...
- [7th-green/gha-playwright](https://github.com/7th-green/gha-playwright) -  (4 days ago)
...
- [[BUGFIX] Keep QueryParams on Refresh in Log Module](https://github.com/tomasnorre/crawler/pull/1292) on [tomasnorre/crawler](https://github.com/tomasnorre/crawler) (1 month ago)
- [[BUGFIX] Keep QueryParams on Refresh in Log Module](https://github.com/tomasnorre/crawler/pull/1291) on [tomasnorre/crawler](https://github.com/tomasnorre/crawler) (1 month ago)
- [[BUGFIX] Add missing class for checkboxes for LogModule](https://github.com/tomasnorre/crawler/pull/1290) on [tomasnorre/crawler](https://github.com/tomasnorre/crawler) (1 month ago)
- [[BUGFIX] Add missing class for checkboxes for LogModule](https://github.com/tomasnorre/crawler/pull/1289) on [tomasnorre/crawler](https://github.com/tomasnorre/crawler) (1 month ago)
...
- [7th-green/gha-playwright](https://github.com/7th-green/gha-playwright) ([v1.0.8](https://github.com/7th-green/gha-playwright/releases/tag/v1.0.8), 4 days ago) - 
- [ddev/ddev](https://github.com/ddev/ddev) ([v1.25.3](https://github.com/ddev/ddev/releases/tag/v1.25.3), 3 weeks ago) - Docker-based local PHP&#43;Node.js web development environments
- [TYPO3BestPractices/tea](https://github.com/TYPO3BestPractices/tea) ([v4.1.0](https://github.com/TYPO3BestPractices/tea/releases/tag/v4.1.0), 3 weeks ago) - Example extension for unit testing and best practices.

#### 📜 My recent [blog posts](https://blog.tomasnorre.dk)

- [Self-hosted Docker Registry](https://blog.tomasnorre.dk/blog/self-hosted-docker-registry/) (3 months ago)
- [Post Ideas](https://blog.tomasnorre.dk/blog/post-ideas/) (3 months ago)
- [Jigsaw - Related articles](https://blog.tomasnorre.dk/blog/jigsaw-related-articles/) (6 months ago)
- [How to set up a self-hosted GitHub Runner](https://blog.tomasnorre.dk/blog/self-hosted-github-runner/) (6 months ago)
...
- [voku/portable-ascii](https://github.com/voku/portable-ascii) - 🔡 Portable ASCII library - performance optimized (ascii) string functions for PHP. (5 months ago)
- [vlucas/phpdotenv](https://github.com/vlucas/phpdotenv) - Loads environment variables from `.env` to `getenv()`, `$_ENV` and `$_SERVER` automagically. (5 months ago)

#### ❤️ These awesome people [sponsor me](https://github.com/sponsors/tomasnorre) (thank you!)

- [oliverklee](https://github.com/oliverklee) (6 years ago)
